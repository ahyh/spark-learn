...
object JdbcRddDemo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val jdbcRdd: JdbcRDD[(Int, String, Int, Int, String, java.math.BigDecimal)] = new JdbcRDD(sc, getConn, "select * from salary where id >= ? and id <= ?", 12, 100, 4, rs => {
      val id = rs.getInt(1)
    ...
    //触发Action
    val r: Array[(Int, String, Int, Int, String, java.math.BigDecimal)] = jdbcRdd.collect()
